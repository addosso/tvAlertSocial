...
module.exports = raiObjectifier;

function raiObjectifier(canale,arr_or_element_to_objectify, additionalParams){
    ...
    var showObject = {};
    showObject.title = arr_or_element_to_objectify.titolo;
    showObject.hashtag = "";
